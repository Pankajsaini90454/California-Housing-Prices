...
# 5. pipeline for numerical columns
...
print("linear regression rmses",pd.Series(lin_rmses).describe())
...
print("decision tree rmses",pd.Series(dec_rmses).describe())
...
print("random forest rmses",pd.Series(random_forest_rmses).describe())